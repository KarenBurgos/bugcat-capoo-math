        ...
        <d iv className="">
          <nav className="hidden md:inline min-[1024px]:block">
            <div
              ...
              className="absolute z-10 md:mt-2 mx-8  hover:cursor-pointer"
            >
              <p>Regresar</p>
              <svg
                className="w-20 h-20"
          ...
          <div className="flex items-center justify-center md:hidden relative">
            <div
              className="md:hidden absolute z-10 top-2 left-5"
              onClick={() => {
                setMovilMenu(true);
              }}
            >
          ...
          {movilMenu && (
            <nav className="md:hidden h-screen absolute z-20 bg-white rounded top-0">
              <div className="md:hidden h-full divide-y-2">
                <div className="flex relative justify-center w-full py-5">
                  <p
                    className={`text-2xl text-${OperationsColor(operation)[2]}`}
                  >
                    Operaciones
                  </p>
                  <IoClose
                ...
                <div className="h-full grid grid-rows-[70%,30%] items-center justify-center">
                  <div className="flex flex-col h-full items-start px-16 pt-10 text-xl">
                    <Link
                      ...
                      className={`py-5 w-full px-10 ${path.startsWith("/aprender/Suma") && "bg-yellow-light"}`}
                    >
                      Suma
                    </Link>
                    <Link
                      to="/aprender/Resta/Explicacion"
                      className={`py-5 w-full px-10 ${path.startsWith("/aprender/Resta") && "bg-pink-light"}`}
                    >
                      Resta
                    </Link>
                    <Link
                      to="/aprender/Multiplicacion/Explicacion"
                      className={`py-5 w-full px-10 ${path.startsWith("/aprender/Multiplicacion") && "bg-purple-light"}`}
                    >
                      Multiplicación
                    </Link>
                    <Link
                      to="/aprender/Division/Explicacion"
                      className={`py-5 w-full px-10 ${path.startsWith("/aprender/Division") && "bg-blue-light"}`}
                    >
                      División
                    </Link>
                  </div>
          ...
          <h1
            className={`font-bold text-5xl md:text-[6rem] text-center text-${OperationsColor(operation)[0]} ${operation == "Multiplicación" && "text-[2rem] md:text-6xl"} `}
          >
            {operation}
          </h1>
        </d>
