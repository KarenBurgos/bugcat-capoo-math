...
export default function Step5() {
  return (
    <Container img={subtractionImg} color="#FD88BE">
      ...
      <section
        id="container-case-3-sub"
        className="grid min-[1220px]:flex text-3xl items-end my-10 min-[1220px]:my-0"
      >
        <article className="grid justify-center items-center relative min-[1220px]:flex min-[1220px]:justify-between min-[1220px]:m-0">
          ...
          <embed
            src={Arrow}
            className="mt-10 h-14 rotate-90 min-[1220px]:rotate-0 md:mr-10 w-full min-[1220px]:mt-0"
          />
        </article>
        ...
        <article className="grid justify-center items-center relative min-[1220px]:flex min-[1220px]:justify-between min-[1220px]:m-0">
          ...
          <embed
            src={Arrow}
            className="my-10 h-16 rotate-90 min-[1220px]:rotate-0 md:mr-10 w-full"
          />
        </article>
      ...
      <section id="container-case-2-sub">
        ...
        <p className="py-4">
          {" "}
          Primero se presta 1 a el número que se tiene a la derecha y se resta
          el 1 que acaba de prestar (en este caso el 2 queda como 1 y el 0 como
          10)
        </p>
        <p className="py-4">
          {" "}
          Ahora si se puede pedir prestado 1 al 10 y se realiza la resta{" "}
        </p>
