        ...
        <div>
          ...
          <div className="flex flex-col ">
            <p className="py-4 text-xl">
              Si tenemos 3 botes con tres caramelos en cada uno y queremos saber
              cuántos caramelos tenemos en total, tendríamos que sumar 3 cuatro
              veces. En lugar de esto utilizamos las tablas de multiplicar para
              saber el resultado{" "}
            </p>
            <div className=" md:flex items-center justify-center">
              ...
              <div className="min-[1220px]:px-10 flex justify-center">
                <embed
                  src={Arrow}
                  className="h-full w-max-full rotate-90 my-10 md:rotate-0 min-[1200px]:m-0"
                />
              </div>
