...
export default function step3() {
    return (
        <Container img={multiplicationImg} step="3" color="#9B5ED8">
            ...
            <p className="py-10"> Como ya no hay mas números que multiplicar de la primera fila colocamos el resultado sin simportar que sea mayor a 10 porque no hay mas lugares donde llevar</p>
