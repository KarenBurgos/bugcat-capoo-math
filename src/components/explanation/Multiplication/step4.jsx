...
export default function step4() {
  return (
    <Container img={multiplicationImg} step="4" color="#9B5ED8">
      <p className="py-4">
        Ahora que ya multiplicamos el primer número con todos los números de la
        columna de arriba tomamos el siguiente número de la ultima columna y la
        multiplicamos con todos los numero de arriba como lo hicimos antes,{" "}
        <span className="underline text-pink">empezando por la derecha.</span>
      </p>
        ...
        <div className="flex flex-col">
          <div className="flex">
            <div className="flex relative">
              <table className="table-auto border-collapse border border-gray-300 border-dashed">
                <tbody>
                  <tr>
                    ...
                    <td className="border border-2 border-gray-400 border-dashed px-8 md:px-10 py-5 text-pink">
                      5
                    </td>
                  </tr>
                  <tr>
                    <td></td>
                    <td
                      className="border border-2 border-gray-400 border-b-gray-700 border-dashed px-8 md:px-10 py-5 text-purple"
                      style={{ borderBottom: "4px solid rgb(55 65 81)" }}
                    >
                      1
                    </td>
                    <td
                      className="border border-2 border-gray-400  border-b-gray-700 border-dashed px-8 md:px-10 py-5 "
                      style={{ borderBottom: "4px solid rgb(55 65 81)" }}
                    >
                      5
                    </td>
              ...
              <embed
                src={Arrow}
                className="h-14 absolute top-14 left-32 md:left-40 -rotate-45"
              />
            </div>
      ...
      <div>
        <p className="py-10">
          Pero para colocar el resultado debemos de dejar un espacio en blanco
            ...
            <table className="table-auto border-collapse border border-gray-300 border-dashed text-3xl">
              <tbody>
                ...
                <tr>
                  ...
                  <td></td>
                  <td
                    className="border border-2 border-gray-400 px-8 md:px-10 py-5 border-dashed text-purple"
                    style={{ borderBottom: "4px solid rgb(55 65 81)" }}
                  >
                    1
                  </td>
                  <td
                    className="border border-2 border-gray-400 px-8 md:px-10 py-5  border-dashed"
                    style={{ borderBottom: "4px solid rgb(55 65 81)" }}
                  >
                    5
                  </td>
