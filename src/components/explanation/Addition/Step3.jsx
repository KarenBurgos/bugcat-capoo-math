...
export default function Step3() {
  return (
    <Container img={additionImg} step="3" color="#FEEB70">
      <p className="py-4">
        Luego sumas la siguiente columna junto con el 1 que agragaste arriba. Si
        en la casilla no hay ningun numero quiere decir que es 0
      </p>
      ...
      <section className="w-full grid md:flex justify-center md:justify-between text-3xl items-center">
        ...
        <section className="w-full flex items-center justify-center py-14">
          <embed
            className="-rotate-90 md:p-0 md:rotate-0 flex justify-center items-center"
            src={leftArrow}
          />
        </section>
