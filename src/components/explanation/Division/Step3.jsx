  ...
  return (
    <div>
      <Container img={divImg} step="3" color="#98E6E6">
        <p>
          Ahora restamos el 8 del dividendo con el 4 que resulto de la
          multiplicación
        </p>
            ...
            <table className="text-2xl">
              <tr>
                <td className="px-5 py-1">
                  <span className="text-blue-medium pl-2">8</span>2
                </td>
                <td
              ...
              <tr>
                <td className="px-5  text-blue-medium underline decoration-black">
        ...
        <section>
          <p>
            Luego de colocar el resultado de la resta bajamos el siguiente
            número del divisor a la par
          </p>
          <div className="my-10">
            <table className="text-2xl grid justify-center md:justify-start">
              <tr>
                <td className="px-5 py-1">
                  <span className="text-blue-medium pl-2 pr-1">8</span>2
                </td>
                <td
                  className="px-5 py-1 text-blue-medium"
                  style={{
        ...
        <section className="my-5">
          <p>
            Ahora tomamos el número que tenemos abajo el nuevo dividendo (si el
            residuo fuera 1 y bajaramos el 2 el nuevo dividendo seria 12) y
            realizamos el mismo proceso para dividir
          </p>
