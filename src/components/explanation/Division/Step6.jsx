    ...
    return (
        <div>
            <Container img={divImg} step="" color="#98E6E6">
                ...
                <p className="my-5">El divisor es un solo dígito asi que tomamos un solo digito del dividendo</p>
                <table className="">
                    <tr>
                        <td className="px-5 py-1 pl-7"><span className="text-blue-medium">1</span> 50</td>
                ...
                <section className="grid md:flex items-center">
                    ...
                    <table className="grid justify-center">
                        ...
                        <tr>
                            <td className="px-5 underline decoration-black"><span className="text-customBlack">-</span>15</td>
