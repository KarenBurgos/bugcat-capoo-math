      ...
      <Container img={divImg} step="" color="#98E6E6">
        ...
        <div className="flex w-full items-center">
          <p className="whitespace-nowrap">
            Veamos el siguiente ejemplo 1050 ÷ 10
          </p>
        ...
        <p className="my-5">
          Empezamos tomando dos dígitos del dividendo ya que le dividos tien 2
          dígitos y realizamos la división
        </p>
        <table className="grid justify-center md:justify-start">
          <tr>
            <td className="px-5 py-1 pl-7">
              <span className="text-blue-medium">10</span>50
            </td>
            <td
        ...
        <p className="my-5">
          Ahora bajamos el siguiente número. Aqui nos damos cuenta que no
          podemos dividir 5 entre 10 ya que el 5 es menor, pero aun tenemos un 0
          en el dividendo que podemos bajar
        </p>
        <table className="grid justify-center md:justify-start">
          <tr>
          ...
          <tr>
            <td className="px-5 py-1 pl-9 ">
              0 <span className="text-blue-medium">5</span>
            </td>
            <td className="px-5 pl-7 py-1"></td>
          </tr>
        </table>
        <p className="my-5">
          Para bajar ese 0 y que nos quede 50 entre 10 tenemos que poner primero
          un 0 al cociente
        </p>
        ...
        <p>
          Por lo que la respuesta a la division 1050 ÷ 10 es:{" "}
          <p className="text-blue-medium">Cociente= 105, residuo= 0</p>
        </p>
        <div className="my-10 p-10 bg-yellow-dark bg-opacity-20">
          <p>
            Al iniciar la división podemos tomar mas dígitos para poder dividir
            sin agregar un 0 al cociente. Este 0 se agrega solo cuando ya hemos
            empezado a dividir y necesitemos bajar otro número
          </p>
        </div>
      </Container>
    </div>
