        ...
        <div>
            ...
            <Container img={divImg} step="1" color="#98E6E6">
                <section id="div-1" className=" pb-10 grid gap-5">
                    ...
                    <p className="">El número que esta a la izquierda del simbolo de división es el dividendo y el que esta a la derecha es el divisor</p>
                </section >

                <section id="div-1-operation" className="w-full flex text-2xl justify-center md:justify-start mb-10">
                    <table>
                        <tr>
