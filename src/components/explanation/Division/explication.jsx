    ...
    return (
        <div className="pr-14 md:py-10 md:px-20 flex items-start text-justify">
            ...
            <div className="flex flex-col w-full text-xl">
                ...
                <section id="division-parts" className="py-5 grid grid-cols-1 min-[1220px]:grid-cols-[30%,70%] justify-center" >
                    <article className="mb-10 w-full  flex place-items-center md:place-items-start">
                        <img src={divisionComponentes} alt="partes en que se compone la división" className=""/>
                    </article>
                ...
                <section id="division-example" className="grid items-center justify-center md:justify-start">
