  ...
  return (
    <div>
      <Container img={divImg} step="" color="#98E6E6">
        ...
        <p>
          Si no hay un número que al multiplicarlo con el dividendo nos de igual
          al divisor tenemos que buscar el número mas cercano y pero que sea
          menor
        </p>
          ...
          <table className="grid justify-center mt-5 md:m-0">
            ...
            <tr>
              <td className="px-5 underline decoration-black">
                <span className="text-customBlack">-</span>6
              </td>
        ...
        <div className="my-8 md:my-10">
          <p>
            Ya que no podemos seguir dividiendo porque lo que nos queda es menor
            al divisor este es el residuo. Por lo que la respuesta a la division
            7 ÷ 2 es:{" "}
            <span className="text-blue-medium">Cociente= 3, residuo= 1</span>
          </p>
        </div>
      </Container>
    </div>
