...
import './index.css';
import App from './App';
import LayoutOperation, {loader as loaderLayout} from './pages/Layout/layoutOperation';
import LayoutMain from './pages/Layout/layoutMain';
import Home from './pages/Home';
import ExercisesMain from './pages/exercises/practiceHome';
import Difficult, { loader as loaderDifficult } from './pages/exercises/dificult';
import Exercise, { loader as loaderExercise } from './pages/exercises/exercise'
import LayoutMenuExplanation, {loader as loaderMenuExplanation} from './pages/Layout/layoutMenuExplanation';
